...
export default function DocumentsModal({
  ...
  const documentCard = (document: Document) => {
    const isInvalid = document.name != "Agreement" && !document.templateName;

    return (
      <label
        className={cn(
          "flex cursor-pointer items-center rounded-lg border border-gray-200 p-3 transition-colors duration-200 hover:bg-gray-50",
        )}
      >
        <Checkbox
